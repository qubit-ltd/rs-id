...
/// Number of bits used for the host field in Java-compatible Qubit snowflake IDs.
pub const HOST_BITS: u8 = 9;

/// Minimum valid Java-compatible host identifier.
pub const HOST_MIN: u64 = 0;

/// Maximum valid Java-compatible host identifier.
pub const HOST_MAX: u64 = (1_u64 << HOST_BITS) - 1;

/// Number of bits used for the mode field in Java-compatible Qubit snowflake IDs.
pub const MODE_BITS: u8 = 1;

/// Number of bits used for the precision field in Java-compatible Qubit snowflake IDs.
...
/// Default epoch used by the Java `common-id` implementation: 2018-12-02T00:00:00Z.
