...
#[test]
fn test_id_generation_error_display_formats_all_variants() {
    ...
    let cases = vec![
        ...
        (
            IdGenerationError::MachineIdOutOfRange {
                machine_id: 65_536,
                max: 65_535,
            },
        ...
        (
            IdGenerationError::TimeBeforeEpoch { time, epoch },
        ...
        (
            IdGenerationError::InvalidTimeUnit {
                nanos: 1,
                min_nanos: 1_000_000,
            },
        ...
        (
            IdGenerationError::GeneratorExpired {
                observed_at: epoch,
                expires_at: time,
            },
...
#[test]
fn test_id_generation_error_clock_moved_backwards_preserves_raw_durations() {
    let error = IdGenerationError::ClockMovedBackwards {
